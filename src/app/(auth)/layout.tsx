...
export default function layout(props: AuthLayoutProps) {
  ...
  return (
    <React.Fragment>
      ...
      <div className=" h-[calc(100vh-96px)] bg-[#E7E2FF] dark:bg-card flex flex-col items-center justify-center">
        <div className="container px-0 w-full  min-h-[600px] h-auto flex sm:flex-row flex-col my-4">
          <main className="w-full p-4 flex items-center justify-center mx-auto rounded-s-xl bg-card">
            {children}
          </main>
